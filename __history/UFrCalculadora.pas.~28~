...
procedure TfrCalculadora.btMaisClick(Sender: TObject);
begin
  OperacoesMat.AcrecentarOperacoes('+',edResultado);
end;

procedure TfrCalculadora.btMenosClick(Sender: TObject);
begin
  OperacoesMat.AcrecentarOperacoes('-',edResultado);
end;
...
begin
  OperacoesMat.CalcularResultado(edResultado);
end;

procedure TfrCalculadora.btVirgulaClick(Sender: TObject);
begin
